			...
			<footer className="bg-[#030303] relative z-20 border-t border-white/5 overflow-hidden">
				...
				<div className="max-w-7xl mx-auto px-6 md:px-8 py-16 lg:py-24 grid grid-cols-1 md:grid-cols-2 gap-12 lg:gap-8 relative z-10">
					...
					<div className="flex flex-col items-center md:items-start text-center md:text-left">
						...
						<div className="flex gap-4">
							<a href="https://github.com" aria-label="GitHub" className="group w-12 h-12 rounded-full bg-white/5 border border-white/10 flex items-center justify-center text-gray-400 hover:text-white hover:bg-brand-accent/20 hover:border-brand-accent/50 transition-all duration-500 hover:-translate-y-2 hover:shadow-[0_10px_20px_-10px_rgba(37,99,235,0.6)]">
							...
							<a href="https://linkedin.com" aria-label="LinkedIn" className="group w-12 h-12 rounded-full bg-white/5 border border-white/10 flex items-center justify-center text-gray-400 hover:text-white hover:bg-brand-accent/20 hover:border-brand-accent/50 transition-all duration-500 hover:-translate-y-2 hover:shadow-[0_10px_20px_-10px_rgba(37,99,235,0.6)]">
					...
					<div className="flex flex-col items-center md:items-start text-center md:text-left md:ml-auto md:mr-16">
						<h2 className="text-sm md:text-base uppercase tracking-widest text-gray-400 font-semibold mb-6">Contacto</h2>
				...
				<div className="border-t border-white/5 relative z-10">
					<div className="max-w-7xl mx-auto px-6 md:px-8 py-6 flex flex-col md:flex-row items-center justify-between gap-4">
						<p className="text-[10px] md:text-xs text-gray-400 tracking-[0.15em] uppercase font-semibold text-center md:text-left flex-1">
							© {new Date().getFullYear()} RE-INVENT. Todos los derechos reservados.
						</p>
						<div className="flex gap-6 text-[10px] md:text-xs text-gray-400 tracking-[0.15em] uppercase font-semibold">
